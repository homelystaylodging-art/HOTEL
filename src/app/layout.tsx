...
export const metadata: Metadata = {
  title: 'HomelyStay Suites | Comfortable & Hygienic Lodging',
  description: 'Affordable, convenient, and hygiene-focused lodging near Waluj MIDC, Chhatrapati Sambhaji Nagar.',
};
